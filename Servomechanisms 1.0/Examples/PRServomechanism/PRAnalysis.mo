...
model PRAnalysis
  ...
  Modelica.Blocks.Continuous.LimPID PID2(controllerType = .Modelica.Blocks.Types.SimpleController.P, k = kprot, yMax = Voltage) annotation(Placement(transformation(origin = {-7.05874,38.4813}, extent = {{-10,-10},{10,10}})));
  Modelica.Mechanics.Rotational.Components.IdealGear idealgear2(ratio = ratio2) annotation(Placement(transformation(origin = {60.6359,38.9669}, extent = {{-10,-10},{10,10}})));
  Modelica.Mechanics.Rotational.Sensors.AngleSensor anglesensor1 annotation(Placement(transformation(origin = {27.3227,7.24009}, extent = {{10,-10},{-10,10}})));
  Modelica.Blocks.Continuous.LimPID PID1(controllerType = .Modelica.Blocks.Types.SimpleController.P, k = kppris, yMax = Voltage, Ti = 20) annotation(Placement(transformation(origin = {-4.52668,-50.3306}, extent = {{-10,-10},{10,10}})));
  Servomechanisms.Electrical.SignalDCMotor signaldcmotor1(R = R, L = L, kt = k, J = J) annotation(Placement(transformation(origin = {26.4604,-49.6239}, extent = {{-10,-10},{10,10}})));
  Modelica.Mechanics.Rotational.Components.IdealGearR2T idealgearr2t1(ratio = ratio1) annotation(Placement(transformation(origin = {58.7457,-50.0923}, extent = {{-10,-10},{10,10}})));
  Modelica.Mechanics.Translational.Sensors.PositionSensor positionsensor1 annotation(Placement(transformation(origin = {25.7288,-82.7724}, extent = {{10,-10},{-10,10}})));
equation
