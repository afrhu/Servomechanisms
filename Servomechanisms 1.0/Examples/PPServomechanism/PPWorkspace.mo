...
model PPWorkspace
  ...
  Servomechanisms.Control.CircleTrajectory circletrajectory1(r = r, xc = xc, yc = yc) annotation(Placement(transformation(origin = {-59.9556,-71.6164}, extent = {{-10,-10},{10,10}})));
