...
model RRMotor2
  ...
  Modelica.Blocks.Sources.Step step1(height = Voltage) annotation(Placement(transformation(origin = {-72.6793,41.3195}, extent = {{-10,-10},{10,10}})));
  ...
  Modelica.Blocks.Continuous.FirstOrder firstorder2(k = 208.7 / 12, T = 0.0093) annotation(Placement(transformation(origin = {-5.05508,-59.4288}, extent = {{-10,-10},{10,10}})));
  Modelica.Blocks.Continuous.Integrator integrator1 annotation(Placement(transformation(origin = {32.3567,-59.6641}, extent = {{-10,-10},{10,10}})));
  Modelica.Blocks.Sources.Step step3(height = 1) annotation(Placement(transformation(origin = {-68.3226,-57.6387}, extent = {{-10,-10},{10,10}})));
  Modelica.Blocks.Continuous.Integrator integrator2 annotation(Placement(transformation(origin = {-2.70214,-7.19351}, extent = {{-10,-10},{10,10}})));
  Modelica.Blocks.Continuous.FirstOrder firstorder1(k = 208.7 / 12, T = 0.0093) annotation(Placement(transformation(origin = {-37.902,-6.88235}, extent = {{-10,-10},{10,10}})));
  Modelica.Mechanics.Rotational.Sensors.SpeedSensor speedsensor1 annotation(Placement(transformation(origin = {83.3922,57.2438}, extent = {{-10,-10},{10,10}})));
  Modelica.Blocks.Sources.Step step2(height = 3.14 / 4) annotation(Placement(transformation(origin = {-14.4462,29.5556}, extent = {{-10,-10},{10,10}})));
  Modelica.Mechanics.Rotational.Sources.Position position1(exact = true) annotation(Placement(transformation(origin = {23.8828,30.3521}, extent = {{-10,-10},{10,10}})));
  Servomechanisms.Mechanism.RR rr1(boxLength1 = l1, boxWidth1 = w1, boxHeight1 = h1, density1 = d1, boxLength2 = l2, boxWidth2 = w2, boxHeight2 = h2, density2 = d2) annotation(Placement(transformation(origin = {73.6781,24.4259}, extent = {{-17.1347,-17.1347},{17.1347,17.1347}})));
  Modelica.Blocks.Continuous.LimPID PID(yMax = Voltage, controllerType = .Modelica.Blocks.Types.SimpleController.P, k = 4.423) annotation(Placement(transformation(origin = {-35.66,-57.7621}, extent = {{-10,-10},{10,10}})));
equation
  ...
  annotation( experiment(StartTime = 0, StopTime = 1, Tolerance = 0.000001), Documentation(info = "<html>
<head>
<style type=\"text/css\">
