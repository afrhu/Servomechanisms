...
model RRPositionControl
  ...
  Modelica.Blocks.Continuous.LimPID PID(controllerType = .Modelica.Blocks.Types.SimpleController.P, k = kp1, yMax = Voltage) annotation(Placement(transformation(origin = {-9.54063,37.4558}, extent = {{-10,-10},{10,10}})));
  ...
  Servomechanisms.Electrical.SignalDCMotor signaldcmotor2(R = R, L = L, kt = k, J = J) annotation(Placement(transformation(origin = {27.193,38.9232}, extent = {{-10,-10},{10,10}})));
  Modelica.Blocks.Continuous.LimPID limpid1(controllerType = .Modelica.Blocks.Types.SimpleController.P, k = kp2, yMax = Voltage) annotation(Placement(transformation(origin = {-6.85512,-40.0707}, extent = {{-10,-10},{10,10}})));
  Servomechanisms.Electrical.SignalDCMotor signaldcmotor1(R = R, L = L, kt = k, J = J) annotation(Placement(transformation(origin = {28.4651,-39.31}, extent = {{-10,-10},{10,10}})));
...
<h4>General</h4>
<p>
In this model the trajectory trackintg for RR servomechanisms is tested using PID block and signal DC motor.
</p>
