...
model RRMotor1
  ...
  Modelica.Blocks.Sources.Step step1(height = Voltage) annotation(Placement(transformation(origin = {-77.3852,21.5548}, extent = {{-10,-10},{10,10}})));
  ...
  Modelica.Blocks.Continuous.FirstOrder firstorder1(k = 104.34 / 12, T = 0.0115) annotation(Placement(transformation(origin = {-16.2361,-17.0467}, extent = {{-10,-10},{10,10}})));
  Servomechanisms.Mechanism.RR rr1(boxLength1 = l1, boxWidth1 = w1, boxHeight1 = h1, density1 = d1, boxLength2 = l2, boxWidth2 = w2, boxHeight2 = h2, density2 = d2) annotation(Placement(transformation(origin = {72.9152,13.5512}, extent = {{-23.9046,-23.9046},{23.9046,23.9046}})));
  Modelica.Mechanics.Rotational.Sensors.SpeedSensor speedsensor1 annotation(Placement(transformation(origin = {48.0846,-7.42933}, extent = {{-10,-10},{10,10}})));
  Modelica.Blocks.Continuous.FirstOrder firstorder2(k = 104.34 / 12, T = 0.0115) annotation(Placement(transformation(origin = {-20.323,-67.0459}, extent = {{-10,-10},{10,10}})));
  Modelica.Blocks.Continuous.Integrator integrator1 annotation(Placement(transformation(origin = {17.0887,-67.2812}, extent = {{-10,-10},{10,10}})));
  Modelica.Blocks.Sources.Step step3(height = 1) annotation(Placement(transformation(origin = {-83.5906,-65.2558}, extent = {{-10,-10},{10,10}})));
  Modelica.Blocks.Continuous.LimPID PID(yMax = Voltage, controllerType = .Modelica.Blocks.Types.SimpleController.P, k = 7.1543) annotation(Placement(transformation(origin = {-49.2643,-65.8695}, extent = {{-10,-10},{10,10}})));
equation
  ...
  annotation( experiment(StartTime = 0, StopTime = 2, Tolerance = 0.000001), Documentation(info = "<html>
<head>
<style type=\"text/css\">
