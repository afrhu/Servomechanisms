...
model RRMotor1Control
  ...
  Modelica.Blocks.Sources.Step step1(height = 1) annotation(Placement(visible = true, transformation(origin = {-84.444,13.5548}, extent = {{-10,-10},{10,10}}, rotation = 0)));
  Modelica.Mechanics.Rotational.Sensors.AngleSensor anglesensor1 annotation(Placement(visible = true, transformation(origin = {-13.1765,-23.5294}, extent = {{10,-10},{-10,10}}, rotation = 0)));
  Modelica.Blocks.Continuous.LimPID PID(k = 7.1543, yMax = Voltage, controllerType = .Modelica.Blocks.Types.SimpleController.P) annotation(Placement(visible = true, transformation(origin = {-47.0392,16.4706}, extent = {{-10,-10},{10,10}}, rotation = 0)));
  Servomechanisms.Mechanism.RR rr1(boxLength1 = l1, boxWidth1 = w1, boxHeight1 = h1, density1 = d1, boxLength2 = l2, boxWidth2 = w2, boxHeight2 = h2, density2 = d2) annotation(Placement(visible = true, transformation(origin = {74.3705,18.168}, extent = {{-19.2543,-19.2543},{19.2543,19.2543}}, rotation = 0)));
equation
  ...
  annotation(Icon(coordinateSystem(extent = {{-100,-100},{100,100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2,2})), Diagram(coordinateSystem(extent = {{-100,-100},{100,100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2,2})), experiment(StartTime = 0, StopTime = 2, Tolerance = 0.000001));
