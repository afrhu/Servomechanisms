...
block MotorBlock
  ...
  Modelica.Blocks.Math.Gain gain1(k = km) annotation(Placement(transformation(origin = {-17.7986,2.8103}, extent = {{-10,-10},{10,10}})));
  Modelica.Blocks.Continuous.TransferFunction transferfunction1(a = {L,R}) annotation(Placement(transformation(origin = {-48.2436,2.8103}, extent = {{-10,-10},{10,10}})));
  ...
  Modelica.Blocks.Continuous.TransferFunction transferfunction2(a = {J,B}) annotation(Placement(transformation(origin = {54.6604,-0.140515}, extent = {{-10,-10},{10,10}})));
equation
