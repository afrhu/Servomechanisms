...
class DCSource
  ...
  //Components
  Modelica.Electrical.Analog.Sources.ConstantVoltage constantvoltage1(V = V) annotation(Placement(transformation(origin = {-50,0}, extent = {{-10,-10},{10,10}}, rotation = -90)));
  Modelica.Electrical.Analog.Basic.Resistor resistor1(R = R) annotation(Placement(transformation(origin = {0,50}, extent = {{-10,-10},{10,10}})));
  Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(transformation(origin = {100.234,-73.4192}, extent = {{-10,-10},{10,10}})));
  //Interfaces
  Modelica.Electrical.Analog.Interfaces.PositivePin pin_p annotation(Placement(transformation(origin = {100,50}, extent = {{-10,-10},{10,10}}), iconTransformation(origin = {-50,-100}, extent = {{-10,-10},{10,10}})));
  Modelica.Electrical.Analog.Interfaces.NegativePin pin_n annotation(Placement(transformation(origin = {100,-50}, extent = {{-10,-10},{10,10}}), iconTransformation(origin = {50,-100}, extent = {{-10,-10},{10,10}})));
equation
...
<h4>Examples</h4>
<a href=\"modelica://Servomechanisms.Examples.RRServomechanism.RRPositionControl2\">RRPositionControl2<a>
