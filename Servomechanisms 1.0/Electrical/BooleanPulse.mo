...
block BooleanPulse "Generate pulse signal of type Boolean"
  ...
  Modelica.Blocks.Interfaces.RealInput u annotation(Placement(transformation(origin = {-108.665,5.62061}, extent = {{-10,-10},{10,10}}), iconTransformation(origin = {-100,0}, extent = {{-10,-10},{10,10}})));
protected
  Modelica.SIunits.Time Twidth = period * u / 100 "width of one pulse" annotation(HideResult = true);
