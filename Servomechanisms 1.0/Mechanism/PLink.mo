...
model PLink "Prismatic Link"
  ...
  //Components
  Modelica.Mechanics.MultiBody.Joints.Prismatic prismatic1(useAxisFlange = true, n = n) annotation(Placement(transformation(origin = {-50,0}, extent = {{-10,-10},{10,10}})));
  ...
  //Interfaces
  Modelica.Mechanics.Translational.Interfaces.Flange_a flange_a annotation(Placement(transformation(origin = {-50,50}, extent = {{-10,-10},{10,10}}), iconTransformation(origin = {-44.1281,5.71332}, extent = {{-10,-10},{10,10}})));
equation
