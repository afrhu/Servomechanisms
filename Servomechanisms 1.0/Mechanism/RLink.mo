...
class RLink "Rotational Link"
  ...
  //Components
  Modelica.Mechanics.MultiBody.Joints.Revolute revolute1(useAxisFlange = true, n = n) annotation(Placement(transformation(origin = {-50,0}, extent = {{-10,-10},{10,10}})));
  ...
  Modelica.Mechanics.MultiBody.Visualizers.FixedFrame origin(length = 0.1) annotation(Placement(transformation(origin = {-48.3988,-44.6021}, extent = {{-10,-10},{10,10}})));
  Modelica.Mechanics.MultiBody.Parts.FixedRotation fixedrotation1(animation = false) annotation(Placement(transformation(origin = {3.18021,51.2367}, extent = {{-10,-10},{10,10}})));
  Modelica.Mechanics.MultiBody.Visualizers.FixedFrame fixedframe1(length = frameFactor) annotation(Placement(transformation(origin = {72.944,51.6523}, extent = {{-10,-10},{10,10}})));
  Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedtranslation1(r = rFrame, animation = false) annotation(Placement(transformation(origin = {35.7793,50.9131}, extent = {{-10,-10},{10,10}})));
  //Interfaces
  Modelica.Mechanics.Rotational.Interfaces.Flange_a flange_a annotation(Placement(transformation(origin = {-50,50}, extent = {{-10,-10},{10,10}}), iconTransformation(origin = {-76.4183,0.76943}, extent = {{-7.52312,-7.52312},{7.52312,7.52312}})));
equation
