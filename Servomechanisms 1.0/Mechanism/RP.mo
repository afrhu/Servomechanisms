...
model RP "RP Mechanism"
  ...
  //Components
  Servomechanisms.Mechanism.RLink rlink1(shape = shape1, n = n1, r = r1, r_CM = r_CM1, m = m1, shapeLength = shapeLength1, shapeWidth = shapeWidth1, shapeHeight = shapeHeight1, shapeType = shapeType1, extra = extra1, I_11 = I_111, I_22 = I_221, I_33 = I_331, I_21 = I_211, I_31 = I_311, I_32 = I_321, boxLength = boxLength1, boxWidth = boxWidth1, boxHeight = boxHeight1, cylinderLength = cylinderLength1, cylinderDiameter = cylinderDiameter1, density = density1) annotation(Placement(transformation(origin = {-29.5583,8.60424}, extent = {{-22.1378,-22.1378},{22.1378,22.1378}})));
  Servomechanisms.Mechanism.PLink plink2(shape = shape2, n = n2, r = r2, r_CM = r_CM2, m = m2, shapeLength = shapeLength2, shapeWidth = shapeWidth2, shapeHeight = shapeHeight2, shapeType = shapeType2, extra = extra2, I_11 = I_112, I_22 = I_222, I_33 = I_332, I_21 = I_212, I_31 = I_312, I_32 = I_322, boxLength = boxLength2, boxWidth = boxWidth2, boxHeight = boxHeight2, cylinderLength = cylinderLength2, cylinderDiameter = cylinderDiameter2, density = density2) annotation(Placement(transformation(origin = {41.2898,8.78092}, extent = {{-23.0212,-23.0212},{23.0212,23.0212}})));
  Modelica.Mechanics.MultiBody.Parts.Fixed fixed1 annotation(Placement(transformation(origin = {-85.5124,8.12721}, extent = {{-10,-10},{10,10}})));
  //Interfaces
  Modelica.Mechanics.Rotational.Interfaces.Flange_a flange_r1 annotation(Placement(transformation(origin = {-46.9965,-35.689}, extent = {{-10,-10},{10,10}}), iconTransformation(origin = {-86.2191,-73.8515}, extent = {{-10,-10},{10,10}})));
  Modelica.Mechanics.Translational.Interfaces.Flange_a flange_p2 annotation(Placement(transformation(origin = {30.3887,-34.9823}, extent = {{-10,-10},{10,10}}), iconTransformation(origin = {-13.0742,1.41346}, extent = {{-10,-10},{10,10}})));
equation
